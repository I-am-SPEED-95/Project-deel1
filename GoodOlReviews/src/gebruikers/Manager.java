...
public class Manager extends Gebruiker implements GebruikerBeheer {

    private static final String FILE_PATH = "src/gebruikers/ManagerLijst.txt";

    public Manager(String gebruikersnaam, String wachtwoord) {
        ...
        try (Scanner scanner = new Scanner(new File(FILE_PATH))) {
            while (scanner.hasNextLine()) {
                ...
                if (credentials[0].equals(gebruikersnaam) && credentials[1].equals(wachtwoord)) {
                    System.out.println("Manager ingelogd: " + gebruikersnaam);
                    return true;
                }
            }
